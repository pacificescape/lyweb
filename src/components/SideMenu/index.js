            ...
            <aside className={this.state.styles.sideBar}>
                <div className={this.state.styles.search}>
                    <div className={this.state.styles.inputWrapper}>
                        <input type="search" placeholder="Search" onChange={this.inputSearch}></input>
                ...
                <ul>
                    ...
                    <li>
                        <NavLink to="/Settings" className="" onClick={this.showSettings.bind(this)}>Settings</NavLink>
